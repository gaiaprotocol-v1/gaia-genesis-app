...
class TeamNFT extends skynode_1.DomNode {
    ...
    async load() {
        ...
        this.emergencyDisplay.empty().appendText(`Emergency ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(reward))} KLAY`);
