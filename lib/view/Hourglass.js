...
class Hourglass {
    constructor() {
        ...
        }), (0, skynode_1.el)("button", "Current", {
            click: () => {
                this.setCurrentKRNOPrice();
            }
        })), (0, skynode_1.el)(".input-wrap", (0, skynode_1.el)("label", "보상이자 (%)"), this.rewardInput = (0, skynode_1.el)("input", {
            change: async () => {
                this.setWealth();
            }
        }), (0, skynode_1.el)("button", "Current", {
