    ...
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = (0, skynode_1.el)("section.mining-view", (0, skynode_1.el)("header", { "data-aos": "zoom-in" }, (0, skynode_1.el)(".title-container", (0, skynode_1.el)("h1", "Mining"), (0, skynode_1.el)("h2", "소유한 NFT로부터 채굴")), (0, skynode_1.el)(".input-container", this.idInput = (0, skynode_1.el)("input", { placeholder: "NFT ID" }), (0, skynode_1.el)("button", "이자 확인", {
            click: async () => {
                ...
                new Alert_1.default("이자 확인", `GAIA #${id} 에는 ${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(krno))} KRNO (${CommonUtil_1.default.numberWithCommas(ethers_1.utils.formatEther(klay))} KLAY)가 쌓여 있습니다.`);
            }
