...
class Mining {
    constructor() {
        ...
        }))), (0, skynode_1.el)("article", { "data-aos": "zoom-in" }, (0, skynode_1.el)(".tool-box", (0, skynode_1.el)(".title-container", (0, skynode_1.el)("header", (0, msg_js_1.default)("MY_NFT_TITLE")), this.totalKRNODisplay = (0, skynode_1.el)("p", (0, msg_js_1.default)("MY_INTEREST_KRNO_DESC").replace(/{amount}/, String("..."))), this.totalKlayDisplay = (0, skynode_1.el)("p", (0, msg_js_1.default)("MY_INTEREST_KLAY_DESC").replace(/{amount}/, String("...")))), (0, skynode_1.el)(".button-container", (0, skynode_1.el)("button.all-mining-button", (0, msg_js_1.default)("ALL_CLAIM_KRNO_TITLE"), {
            click: () => {
                new Confirm_1.default((0, msg_js_1.default)("ALL_CLAIM_KRNO_TITLE"), (0, msg_js_1.default)("CLAIM_ALERT_DESC"), (0, msg_js_1.default)("CLAIM_ALERT_BUTTON"), async () => {
                    await GaiaOperationContract_1.default.claim(this.tokenIds, this.krnos);
                    ViewUtil_1.default.waitTransactionAndRefresh();
                });
            },
        }), (0, skynode_1.el)("button.all-mining-button", (0, msg_js_1.default)("ALL_CLAIM_KLAY_TITLE"), {
            click: () => {
                new Confirm_1.default((0, msg_js_1.default)("ALL_CLAIM_KLAY_TITLE"), (0, msg_js_1.default)("CLAIM_ALERT_DESC"), (0, msg_js_1.default)("CLAIM_ALERT_BUTTON"), async () => {
    ...
    async loadRebase() {
        ...
        const blockNumber = await ExtWallet_1.default.loadBlockTime();
