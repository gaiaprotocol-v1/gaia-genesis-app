...
class CheckHolder {
    constructor() {
        ...
        skynode_1.BodyNode.append(this.container = (0, skynode_1.el)(".check-holder", (0, skynode_1.el)("h1", "Gaia 홀더 인증 페이지"), (0, skynode_1.el)("a.discord-login-button", "Login with Discord", {
