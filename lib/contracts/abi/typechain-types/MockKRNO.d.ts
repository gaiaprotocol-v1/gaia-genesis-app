...
export interface MockKRNOInterface extends utils.Interface {
    contractName: "MockKRNO";
    functions: {
...
export interface MockKRNO extends BaseContract {
    contractName: "MockKRNO";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockKRNOInterface;
...
//# sourceMappingURL=MockKRNO.d.ts.map