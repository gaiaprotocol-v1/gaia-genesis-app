...
const KlipSignerContract_1 = __importDefault(require("../contracts/KlipSignerContract"));
...
class Klip extends eventcontainer_1.default {
    ...
    async sign() {
        ...
        await KlipSignerContract_1.default.sign(key);
        return key;
    }
}
Klip.BAPP_NAME = "Gaia Protocol";
